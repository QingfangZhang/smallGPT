...
# device = get_device()[0]
# net.to(device)
# # x = torch.randint(0, 10, (2, 7))
# # x = x.to(device)
# # logits, loss = net(x)
# # print(logits.shape)
# # optimizer = net.configure_optim(learning_rate=0.001, betas=(0.9, 0.999), weight_decay=0.01)
# net.eval()
# idx = torch.tensor([[1], [0]], dtype=torch.long, device=device)
# idx = net.generate(idx, 10, top_k=3)
# print(idx)